export default function BarChart({
	...
	return (
		<div className="flex justify-center items-center m-4 w-[40rem] h-12 bg-zinc-50 dark:bg-zinc-900 transition-colors duration-150 rounded-md overflow-hidden">
			<span
			...
			{isNaN(likesRatio) && (
				<span className="p-4">Ingen stemmer enda</span>
			)}
		</div>
	)
}
