...
import Search from '~/app/(landing)/_components/_search'
...
export default async function Hero() {
  ...
  return (
    <div className="relative flex h-[800px] w-[800px] items-start justify-center overflow-hidden">
      <FlickeringGrid
        ...
        width={800}
      />
      <div className="z-10 mt-64 sm:w-[490px]">
